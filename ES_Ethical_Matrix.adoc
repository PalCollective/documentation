...
The ethical matrix *requires input from a diversity of voices, roles, and experience.* 
...
=== High Level PalCollective Matrix 

**Overview**  
PalCollective is considering implementing an app or other technological solution to connect Gazans with supporters around
the world in order to faciliate mutual aid. 
__This matrix was constructed 9-Mar-2024 and may no longer be up to date as the collective
has undergone substantial changes in that time.__
...
. Palestinian opinions researched by maisj
