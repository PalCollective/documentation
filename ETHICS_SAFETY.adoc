...
We collaborate with all of the focus areas to identify, assess, manage, and mitigate risks. By necessity, our process is iterative. As our collective grows and adapts and learns, we will need to flexibly update our processes and approaches. We are involved in every phase of the lifecycle so as to best safeguard the interests of our app and its users.    
