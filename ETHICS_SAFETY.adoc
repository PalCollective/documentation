...
The *ethical matrix* is a participatory tool that can frame ethical conflicts for deliberation by a dedicated team. A template is available for use by your team, and you can also request that someone from Ethics and Safety provides training on the matrix or participates in discussions regarding ethical conflicts. 

https://github.com/PalCollective/documentation/blob/main/ES_Ethical_Matrix.md[Ethical Matrix]  
